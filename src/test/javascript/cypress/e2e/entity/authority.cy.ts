...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'bb290116-4d5c-4bec-afbb-24a65a482629' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('6802549f-2a6d-4685-a8b3-220cc5b6e173');
      cy.get(`[data-cy="name"]`).should('have.value', '6802549f-2a6d-4685-a8b3-220cc5b6e173');
