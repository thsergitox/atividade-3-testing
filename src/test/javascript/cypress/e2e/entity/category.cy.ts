...
describe('Category e2e test', () => {
  ...
  const categorySample = { description: 'though', dateAdded: '2024-09-09T20:26:22.631Z', status: 'DISABLED' };
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="description"]`).type('reluctantly jittery jellybeans');
      cy.get(`[data-cy="description"]`).should('have.value', 'reluctantly jittery jellybeans');

      cy.get(`[data-cy="sortOrder"]`).type('27254');
      cy.get(`[data-cy="sortOrder"]`).should('have.value', '27254');

      cy.get(`[data-cy="dateAdded"]`).type('2024-09-10T02:19');
      cy.get(`[data-cy="dateAdded"]`).blur();
      cy.get(`[data-cy="dateAdded"]`).should('have.value', '2024-09-10T02:19');

      cy.get(`[data-cy="dateModified"]`).type('2024-09-10T08:42');
      cy.get(`[data-cy="dateModified"]`).blur();
      cy.get(`[data-cy="dateModified"]`).should('have.value', '2024-09-10T08:42');
