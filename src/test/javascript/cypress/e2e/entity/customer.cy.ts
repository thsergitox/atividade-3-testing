...
describe('Customer e2e test', () => {
  ...
  const customerSample = { firstName: 'Abby', lastName: 'Marvin', email: 'g2@yMZmjS.b56j' };
  ...
  describe('new Customer page', () => {
    ...
    it('should create an instance of Customer', () => {
      cy.get(`[data-cy="firstName"]`).type('Carmen');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Carmen');

      cy.get(`[data-cy="lastName"]`).type('Swift');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Swift');

      cy.get(`[data-cy="email"]`).type('gVrA@Lw.2.NK9FX4.LurR.4u1');
      cy.get(`[data-cy="email"]`).should('have.value', 'gVrA@Lw.2.NK9FX4.LurR.4u1');

      cy.get(`[data-cy="telephone"]`).type('+ 31');
      cy.get(`[data-cy="telephone"]`).should('have.value', '+ 31');
